...
This repository contains a hardened, honest workshop-only robotics paper draft for `ebm_transformer_compositional_grasping`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/68.pdf`
